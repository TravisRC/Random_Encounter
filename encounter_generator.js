...
const encntrObstacle = () => {
    ...
    const creature = ["Low growling comes from the brush just off the path, a pack of wolves appear.","Suddenly shadowy figures jump out from the brush brandishing knives, axes, and clubs, Bandits!", "A small gnomish man sits on a rock under a tree with a walking stick laying across his knees just off the path."];
